...
def create_vectorstore(chunks, _api_key):
    """Creates the searchable index and keeps it in memory (Singleton-style)."""
...
user_pdf = st.file_uploader("Upload a PDF for the AI to read", type="pdf")
query = st.text_input("Ask a question about the document:")

# --- MAIN LOGIC ---

if user_pdf and query:
    # Use your new secret key here
    api_key = "INSERT KEY HERE"

    # 1. Extract Text (Cached)
    with st.spinner("Extracting text..."):
        text = get_pdf_text(user_pdf)
